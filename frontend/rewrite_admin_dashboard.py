...
with open('/Users/shivavarma/Fresh_prown/Fresh_prowns/frontend/src/screens/admin/AdminDashboard.jsx', 'r') as f:
    text = f.read()
        ...
        <div className="min-h-screen bg-black text-[#ededed] pt-32 pb-24 px-6 md:px-16 w-full relative z-10 overflow-hidden" style={{ fontFamily: 'Poppins, sans-serif' }}>
            ...
            <div className="max-w-7xl mx-auto relative z-10 flex flex-col items-start w-full mb-12">
                <div className="w-full flex flex-col md:flex-row md:items-end justify-between pb-6 md:pb-12 relative gap-6 md:gap-0">
                    ...
                    <div className="w-full md:w-1/2 flex flex-wrap justify-end gap-4 mt-6 md:mt-0">
                        <Link to="/admin/products" className="py-3 px-6 rounded-[4px] font-[800] text-[11px] md:text-[12px] uppercase tracking-[0.1em] transition-all duration-300 bg-[#111] text-[#eaeaea] border border-[#333] hover:bg-white hover:text-black hover:border-white shadow-xl">Manage Products</Link>
                        <Link to="/admin/orders" className="py-3 px-6 rounded-[4px] font-[800] text-[11px] md:text-[12px] uppercase tracking-[0.1em] transition-all duration-300 bg-[#111] text-[#eaeaea] border border-[#333] hover:bg-white hover:text-black hover:border-white shadow-xl">All Orders</Link>
                        <Link to="/admin/users" className="py-3 px-6 rounded-[4px] font-[800] text-[11px] md:text-[12px] uppercase tracking-[0.1em] transition-all duration-300 bg-blue-600/10 text-blue-400 border border-blue-500/30 hover:bg-blue-600/20 shadow-xl">Manage Users</Link>
                    </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto relative z-10 w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                ...
                <div className="bg-[#0c0c0c] border border-[#1a1a1a] rounded-[16px] p-8 relative overflow-hidden flex flex-col group hover:border-[#333] transition-colors">
                    ...
                    <p className="text-[36px] font-[900] tracking-tighter text-green-400 font-mono leading-none relative z-10">₹{stats.totalRevenue.toFixed(2)}</p>
                </div>
                <div className="bg-[#0c0c0c] border border-[#1a1a1a] rounded-[16px] p-8 relative overflow-hidden flex flex-col group hover:border-[#333] transition-colors">
                    <div className="absolute inset-0 pointer-events-none z-0 opacity-[0.05]" style={{ backgroundImage: "url('data:image/svg+xml,%3Csvg viewBox=\\"0 0 200 200\\" xmlns=\\"http://www.w3.org/2000/svg\\"%3E%3Cfilter id=\\"noiseFilter\\"%3E%3CfeTurbulence type=\\"fractalNoise\\" baseFrequency=\\"0.85\\" numOctaves=\\"3\\" stitchTiles=\\"stitch\\"/>%3C/filter%3E%3Crect width=\\"100%25\\" height=\\"100%25\\" filter=\\"url(%23noiseFilter)\\"/>%3C/svg%3E')" }}></div>
                    ...
                    <p className="text-[36px] font-[900] tracking-tighter text-purple-400 font-mono leading-none relative z-10">₹{stats.comm1Rev.toFixed(2)}</p>
                </div>
                <div className="bg-[#0c0c0c] border border-[#1a1a1a] rounded-[16px] p-8 relative overflow-hidden flex flex-col group hover:border-[#333] transition-colors">
                    <div className="absolute inset-0 pointer-events-none z-0 opacity-[0.05]" style={{ backgroundImage: "url('data:image/svg+xml,%3Csvg viewBox=\\"0 0 200 200\\" xmlns=\\"http://www.w3.org/2000/svg\\"%3E%3Cfilter id=\\"noiseFilter\\"%3E%3CfeTurbulence type=\\"fractalNoise\\" baseFrequency=\\"0.85\\" numOctaves=\\"3\\" stitchTiles=\\"stitch\\"/>%3C/filter%3E%3Crect width=\\"100%25\\" height=\\"100%25\\" filter=\\"url(%23noiseFilter)\\"/>%3C/svg%3E')" }}></div>
                    ...
                    <p className="text-[36px] font-[900] tracking-tighter text-pink-400 font-mono leading-none relative z-10">₹{stats.comm2Rev.toFixed(2)}</p>
                </div>
            </div>
...
with open('/Users/shivavarma/Fresh_prown/Fresh_prowns/frontend/src/screens/admin/AdminDashboard.jsx', 'w') as f:
