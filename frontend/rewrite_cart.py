...
with open('/Users/shivavarma/Fresh_prown/Fresh_prowns/frontend/src/screens/CartScreen.jsx', 'r') as f:
    text = f.read()
            ...
            <div className="max-w-7xl mx-auto relative z-10 flex flex-col items-start w-full">
                ...
                {cartItems.length === 0 ? (
                    <div className="w-full py-24 flex flex-col items-center justify-center border border-[#1a1a1a] border-dashed rounded-[16px] bg-[#0c0c0c] relative overflow-hidden">
                        ...
                        <Link to="/" className="relative z-10 px-8 py-4 bg-[#eaeaea] text-[#111] font-[800] text-[13px] uppercase tracking-[0.1em] rounded-[4px] hover:bg-white transition-all duration-300">
                            CATCH SOME PROWNS
                        </Link>
                    </div>
                ) : (
                                ...
                                <div className="relative z-10 flex flex-col">
                                    ...
                                    <div className="space-y-6 mb-8">
                                        <div className="flex justify-between items-center text-[13px] font-[600] text-[#888] tracking-wider uppercase font-mono">
                                            ...
                                            <span className="text-white">{cartItems.reduce((acc, item) => acc + item.quantity, 0)} kg</span>
                                        </div>
...
with open('/Users/shivavarma/Fresh_prown/Fresh_prowns/frontend/src/screens/CartScreen.jsx', 'w') as f:
