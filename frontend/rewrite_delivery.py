...
with open('/Users/shivavarma/Fresh_prown/Fresh_prowns/frontend/src/screens/DeliveryScreen.jsx', 'r') as f:
    text = f.read()
                    ...
                    <form onSubmit={submitHandler} className="space-y-10 relative z-10 w-full">
                        ...
                        <div className="pb-8 border-b border-[#222]">
                            ...
                            <div className="space-y-4">
                                <label className={`flex items-center space-x-4 p-4 border rounded-[8px] cursor-pointer transition-all duration-300 ${dateType === '24 hours' ? 'bg-[#111] border-[#eaeaea] shadow-[0_0_15px_rgba(255,255,255,0.05)]' : 'bg-transparent border-[#222] hover:border-white/30'}`}>
                                    <input type="radio" checked={dateType === '24 hours'} onChange={() => setDateType('24 hours')} className="w-5 h-5 accent-white cursor-pointer" />
                                    <span className="text-[14px] font-[600] uppercase tracking-wider text-white">Deliver Within 24 Hours</span>
                                </label>
...
with open('/Users/shivavarma/Fresh_prown/Fresh_prowns/frontend/src/screens/DeliveryScreen.jsx', 'w') as f:
