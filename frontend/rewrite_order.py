...
with open('/Users/shivavarma/Fresh_prown/Fresh_prowns/frontend/src/screens/OrderScreen.jsx', 'r') as f:
    text = f.read()

start_idx = text.find('    if (loading) return <div className="text-center mt-20">Loading order details...</div>;')

imports_and_logic = text[:start_idx]

new_return = """    if (loading) return <div className="min-h-screen bg-black text-[#ededed] flex items-center justify-center pt-32 pb-24 font-mono text-sm tracking-widest uppercase">Fetching Order Data...</div>;
...
with open('/Users/shivavarma/Fresh_prown/Fresh_prowns/frontend/src/screens/OrderScreen.jsx', 'w') as f:
