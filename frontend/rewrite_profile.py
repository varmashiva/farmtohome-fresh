...
with open('/Users/shivavarma/Fresh_prown/Fresh_prowns/frontend/src/screens/ProfileScreen.jsx', 'r') as f:
    text = f.read()
                                        ...
                                        <tbody>
                                            {orders.map((order) => (
                                                <tr key={order._id} className="border-b border-[#1a1a1a] hover:bg-[#111]/50 transition-colors group">
                                                    ...
                                                    <td className="py-5 px-6 text-center">
                                                        <span className={`inline-block px-2 py-1 text-[10px] font-[800] uppercase tracking-widest rounded-[4px] border ${order.status === 'Delivered' ? 'bg-green-500/10 text-green-400 border-green-500/20' : order.status === 'Cancelled' ? 'bg-red-500/10 text-red-500 border-red-500/20' : 'bg-[#111] text-[#eaeaea] border-[#333]'}`}>
                                                            {order.status}
                                                        </span>
                                                    </td>
...
with open('/Users/shivavarma/Fresh_prown/Fresh_prowns/frontend/src/screens/ProfileScreen.jsx', 'w') as f:
