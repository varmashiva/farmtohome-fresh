...
with open('/Users/shivavarma/Fresh_prown/Fresh_prowns/frontend/src/screens/admin/UserListScreen.jsx', 'r') as f:
    text = f.read()
...
with open('/Users/shivavarma/Fresh_prown/Fresh_prowns/frontend/src/screens/admin/UserListScreen.jsx', 'w') as f:
